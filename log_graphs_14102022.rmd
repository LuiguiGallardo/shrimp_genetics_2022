...
### Module A and B: Intestine and hepatopancreas probiotics
```{r, echo=FALSE, fig.width=5, fig.height=5}
# Data input
...
#Plot tiff
ggsave(filename = "01_main_figures/11_adiv_genetics/fig3_a.tiff",
       width=5,
       height=5,
       dpi=300,
       device="tiff")
...
#Plot tiff
ggsave(filename = "01_main_figures/11_adiv_genetics/fig3_b.tiff",
       width=5,
       height=5,
       dpi=300,
       device="tiff")
