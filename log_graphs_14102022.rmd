...
table$group <- factor(table$group, levels = c("Hepatopancreas Gen 1", "Hepatopancreas Gen 2",
    "Intestine Gen 1", "Intestine Gen 2",
    "Intestine healthy", "Intestine diseased"))

# Only Hepatopancreascreas
table_hep <- filter(table, group == "Hepatopancreas Gen 1" | group == "Hepatopancreas Gen 2")
...
```{r, echo=FALSE, fig.width=5, fig.height=5}
# Only hepatopancreas
table_hep <- filter(table, group == "Intestine Gen 1" | group == "Intestine Gen 2")
