---
title: "boxplots_probiotics_genetics_v2"
output: pdf_document
date: "2024-09-03"
---
...
generate_probiotics_boxplot(data_file = "./gut_genus_probiotics_v2.tsv", 
                            comparison = "relab_gut_genus",
                            groups_to_compare = list(c("Gen1", "Gen2")),
                            y_axis = "Relative abundance",
                            output_file = "./genus_gut_probiotics_v2")
```
...
generate_probiotics_boxplot(data_file = "./gut_genus_probiotics_v2.tsv", 
                            ...
                            output_file = "./log_genus_gut_probiotics_v2")
```

### Species gut
```{r, echo=FALSE, fig.width=5, fig.height=5}
# Gut probiotics species
generate_probiotics_boxplot(data_file = "./gut_species_probiotics_v2.tsv", 
                            comparison = "relab_gut_species",
                            groups_to_compare = list(c("Gen1", "Gen2")),
                            y_axis = "Relative abundance",
                            output_file = "./species_gut_probiotics_v2")
```
...
generate_probiotics_boxplot(data_file = "./gut_species_probiotics_v2.tsv", 
                            ...
                            groups_to_compare = list(c("Gen1", "Gen2")),
                            y_axis = "Relative abundance (log10)",
                            output_file = "./log_species_gut_probiotics_v2")
```

### Genus hep 
```{r, echo=FALSE, fig.width=5, fig.height=5}
# Hep probiotics genus
generate_probiotics_boxplot(data_file = "./hep_genus_probiotics_v2.tsv", 
                            comparison = "relab_hep_genus",
                            groups_to_compare = list(c("Gen1", "Gen2")),
                            y_axis = "Relative abundance",
                            output_file = "./genus_hep_probiotics_v2")
```
...
generate_probiotics_boxplot(data_file = "./hep_genus_probiotics_v2.tsv", 
                            ...
                            groups_to_compare = list(c("Gen1", "Gen2")),
                            y_axis = "Relative abundance (log10)",
                            output_file = "./log_genus_hep_probiotics_v2")
```

### Species hep
```{r, echo=FALSE, fig.width=5, fig.height=5}
# Hep probiotics species
generate_probiotics_boxplot(data_file = "./hep_species_probiotics_v2.tsv", 
                            comparison = "relab_hep_species",
                            groups_to_compare = list(c("Gen1", "Gen2")),
                            y_axis = "Relative abundance",
                            output_file = "./species_hep_probiotics_v2")
```
...
generate_probiotics_boxplot(data_file = "./hep_species_probiotics_v2.tsv", 
                            ...
                            groups_to_compare = list(c("Gen1", "Gen2")),
                            y_axis = "Relative abundance (log10)",
                            output_file = "./log_species_hep_probiotics_v2")
```

### Genus gut wt 
```{r, echo=FALSE, fig.width=5, fig.height=5}
# Gut wt probiotics genus
generate_probiotics_boxplot(data_file = "./wt_genus_probiotics_v2.tsv", 
                            comparison = "relab_gut_genus",
                            groups_to_compare = list(c("Healthy", "Disease")),
                            y_axis = "Relative abundance",
                            output_file = "./genus_wt_probiotics_v2")
```
...
generate_probiotics_boxplot(data_file = "./wt_genus_probiotics_v2.tsv", 
                            ...
                            groups_to_compare = list(c("Healthy", "Disease")),
                            y_axis = "Relative abundance (log10)",
                            output_file = "./log_genus_wt_probiotics_v2")
```

### Species gut wt 
```{r, echo=FALSE, fig.width=5, fig.height=5}
# Gut wt probiotics species
generate_probiotics_boxplot(data_file = "./wt_species_probiotics_v2.tsv", 
                            comparison = "relab_gut_species",
                            groups_to_compare = list(c("Healthy", "Disease")),
                            y_axis = "Relative abundance",
                            output_file = "./species_wt_probiotics_v2")
```
...
generate_probiotics_boxplot(data_file = "./wt_species_probiotics_v2.tsv", 
                            ...
                            groups_to_compare = list(c("Healthy", "Disease")),
                            y_axis = "Relative abundance (log10)",
                            output_file = "./log_species_wt_probiotics_v2")
```
