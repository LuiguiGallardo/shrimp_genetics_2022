---
title: "boxplots_probiotics_genetics_v4"
output: pdf_document
date: "2024-09-10"
---
...
generate_probiotics_boxplot(data_file = "./gut_genus_probiotics_v4.tsv", 
                            comparison = "relab_gut_genus",
                            groups_to_compare = list(c("Gen1", "Gen2")),
                            y_axis = "Relative abundance",
                            colors <- c("royalblue", "orangered"),
                            output_file = "./genus_gut_probiotics_v4")
```

### Genus gut log10
```{r, echo=FALSE, fig.width=5, fig.height=5}
# Gut probiotics genus log10
generate_probiotics_boxplot_log(data_file = "./gut_genus_probiotics_v4.tsv", 
                            comparison = "relab_gut_genus",
                            groups_to_compare = list(c("Gen1", "Gen2")),
                            y_axis = "Relative abundance (log10)",
                            colors <- c("royalblue", "orangered"),
                            output_file = "./log_genus_gut_probiotics_v4")
```

### Species gut
```{r, echo=FALSE, fig.width=5, fig.height=5}
# Gut probiotics species
generate_probiotics_boxplot(data_file = "./gut_species_probiotics_v4.tsv", 
                            comparison = "relab_gut_species",
                            groups_to_compare = list(c("Gen1", "Gen2")),
                            y_axis = "Relative abundance",
                            colors <- c("royalblue", "orangered"),
                            output_file = "./species_gut_probiotics_v4")
```

### Species gut log10
```{r, echo=FALSE, fig.width=5, fig.height=5}
# Gut probiotics species
generate_probiotics_boxplot_log(data_file = "./gut_species_probiotics_v4.tsv",
                            comparison = "relab_gut_species",
                            groups_to_compare = list(c("Gen1", "Gen2")),
                            y_axis = "Relative abundance (log10)",
                            colors <- c("royalblue", "orangered"),
                            output_file = "./log_species_gut_probiotics_v4")
```

### Genus hep 
```{r, echo=FALSE, fig.width=5, fig.height=5}
# Hep probiotics genus
generate_probiotics_boxplot(data_file = "./hep_genus_probiotics_v4.tsv", 
                            comparison = "relab_hep_genus",
                            groups_to_compare = list(c("Gen1", "Gen2")),
                            y_axis = "Relative abundance",
                            colors <- c("royalblue", "orangered"),
                            output_file = "./genus_hep_probiotics_v4")
```

### Genus hep log10
```{r, echo=FALSE, fig.width=5, fig.height=5}
# Hep probiotics genus log10
generate_probiotics_boxplot_log(data_file = "./hep_genus_probiotics_v4.tsv",
                            comparison = "relab_hep_genus",
                            groups_to_compare = list(c("Gen1", "Gen2")),
                            y_axis = "Relative abundance (log10)",
                            colors <- c("royalblue", "orangered"),
                            output_file = "./log_genus_hep_probiotics_v4")
```

### Species hep
```{r, echo=FALSE, fig.width=5, fig.height=5}
# Hep probiotics species
generate_probiotics_boxplot(data_file = "./hep_species_probiotics_v4.tsv", 
                            comparison = "relab_hep_species",
                            groups_to_compare = list(c("Gen1", "Gen2")),
                            y_axis = "Relative abundance",
                            colors <- c("royalblue", "orangered"),
                            output_file = "./species_hep_probiotics_v4")
```

### Species hep log10
```{r, echo=FALSE, fig.width=5, fig.height=5}
# Hep probiotics species
generate_probiotics_boxplot_log(data_file = "./hep_species_probiotics_v4.tsv",
                            comparison = "relab_hep_species",
                            groups_to_compare = list(c("Gen1", "Gen2")),
                            y_axis = "Relative abundance (log10)",
                            colors <- c("royalblue", "orangered"),
                            output_file = "./log_species_hep_probiotics_v4")
```

### Genus gut wt 
```{r, echo=FALSE, fig.width=5, fig.height=5}
# Gut wt probiotics genus
generate_probiotics_boxplot(data_file = "./wt_genus_probiotics_v4.tsv", 
                            comparison = "relab_gut_genus",
                            groups_to_compare = list(c("Healthy", "Disease")),
                            y_axis = "Relative abundance",
                            colors <- c("darkviolet", "mediumseagreen"),
                            output_file = "./genus_wt_probiotics_v4")
```

### Genus gut wt log10
```{r, echo=FALSE, fig.width=5, fig.height=5}
# Gut wt probiotics genus log10
generate_probiotics_boxplot_log(data_file = "./wt_genus_probiotics_v4.tsv",
                            comparison = "relab_gut_genus",
                            groups_to_compare = list(c("Healthy", "Disease")),
                            y_axis = "Relative abundance (log10)",
                            colors <- c("darkviolet", "mediumseagreen"),
                            output_file = "./log_genus_wt_probiotics_v4")
```

### Species gut wt 
```{r, echo=FALSE, fig.width=5, fig.height=5}
# Gut wt probiotics species
generate_probiotics_boxplot(data_file = "./wt_species_probiotics_v4.tsv", 
                            comparison = "relab_gut_species",
                            groups_to_compare = list(c("Healthy", "Disease")),
                            y_axis = "Relative abundance",
                            colors <- c("darkviolet", "mediumseagreen"),
                            output_file = "./species_wt_probiotics_v4")
```

### Species gut wt log10
```{r, echo=FALSE, fig.width=5, fig.height=5}
# Gut wt probiotics species log10
generate_probiotics_boxplot_log(data_file = "./wt_species_probiotics_v4.tsv",
                            comparison = "relab_gut_species",
                            groups_to_compare = list(c("Healthy", "Disease")),
                            y_axis = "Relative abundance (log10)",
                            colors <- c("darkviolet", "mediumseagreen"),
                            output_file = "./log_species_wt_probiotics_v4")
```
