---
title: "weighted_centroids_gen_wt"
output: pdf_document
date: "2024-09-03"
---
...
plot_boxplots("./weighted_unifrac_dm_wt_vann_gen.txt", samples, group, groups_to_compare, colors, "./weighted_wt_gen1")
```

### Distance centroids weighted Gen1 vs wt merged
```{r, echo=FALSE, fig.width=5, fig.height=5}
samples <- c("IE2", "IE3", "IE5", "IE7", "IE8", "IE9", "IL1", "IL2", "IL3", "IL4", "IL6", "IL8", "1IS", "IS", "P210", "P2-9", "P212", "P2-11", "P24", "P25", "P28", "P2-14")
...
plot_boxplots("./weighted_unifrac_dm_wt_vann_gen.txt", samples, group, groups_to_compare, colors, "./weighted_wt_gen1_merged")
```


### Distance centroids weighted Gen2 vs wt
```{r, echo=FALSE, fig.width=5, fig.height=5}
...
plot_boxplots("./weighted_unifrac_dm_wt_vann_gen.txt", samples, group, groups_to_compare, colors, "./weighted_wt_gen2")
```

### Distance centroids weighted Gen2 vs wt merged
```{r, echo=FALSE, fig.width=5, fig.height=5}
samples <- c("IA2", "IA3", "IA4", "IA5", "IA7", "IA8", "IA9", "1IS", "IS", "P210", "P2-9", "P212", "P2-11", "P24", "P25", "P28", "P2-14")
...
plot_boxplots("./weighted_unifrac_dm_wt_vann_gen.txt", samples, group, groups_to_compare, colors, "./weighted_wt_gen2_merged")
```