...
library("ggpubr")
# Data input
table <- read.table(file = "values_niche_widht_otu_table_s_0.01_genetics.txt",
    header = TRUE,
    sep = "\t")
table_dfwc <- summarySEwithin(table,
    measurevar="value",
    withinvars="group",
    na.rm=FALSE,
    conf.interval=.95)
...
## Helper functions from: http://www.cookbook-r.com/Graphs/Plotting_means_and_error_bars_(ggplot2)/#Helper%20functions
